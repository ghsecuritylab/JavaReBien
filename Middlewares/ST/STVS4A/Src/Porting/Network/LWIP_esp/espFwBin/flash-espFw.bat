...
@echo off
STUsbCom.exe  --mute listcom >tmp.txt
set /p COM= < tmp.txt
del tmp.txt
...
esp_tool.exe  -p%COM% -b115200 -rnone -of -a0x00000 "espFw.eagle.flash-%VERSION_FW%-0x00000.bin"  -a0x20000 "espFw.eagle.irom0text-%VERSION_FW%-0x20000.bin" -a0x7E000 "blank-%VERSION_FW%-0x7E000.bin" -a0x7C000 "esp_init_data_default-%VERSION_FW%-0x7C000.bin"
echo
pause