...
/* Inline void * CALLOC_with_freertos(size_t nb, size_t itemSize) {size_t size_to_be_allocated = nb*itemSize; void *ptr= pvPortMalloc(size_to_be_allocated); if(ptr) {memset(ptr, 0, size_to_be_allocated);}return ptr;}; */

/* #define MBEDTLS_PLATFORM_STD_CALLOC  CALLOC_with_freertos    derivative from freertos malloc function */

/* #define MBEDTLS_PLATFORM_STD_FREE       vPortFree     freertos memory free function */
