...
#define configUSE_RECURSIVE_MUTEXES             1       /* STVS4A uses re-entrant muxtex  */
#define configSUPPORT_DYNAMIC_ALLOCATION        1       /* STVS4A uses re-entrant muxtex  */
...
#define configMINIMAL_STACK_SIZE            ((uint16_t)128) /*sizes in 32bit words*/
#ifdef CONF_RTOS_ALLOC
...
#define configOVERRIDE_DEFAULT_TICK_CONFIGURATION (0) /* Tickless implementation */
